...
const VALID_SUBROLES: Record<string, Set<string>> = {
    ...
    'Comment': new Set([
        ...
        'shi-de focus',
        'thesis clause',
        'two embedded topic–comment clauses',
    ]),
    'Complement': new Set([
        'acceptability',
        'adjectival predicate',
        'comparative (於-phrase)',
        'degree',
        'directional',
        'duration',
        'duration (inserted into split verb)',
        'frequency',
        'frequency (inserted into split verb)',
        'negated degree',
        'negation',
        'orientation: away from speaker',
        'orientation: toward speaker',
        'orientation: toward speaker (coming out)',
        'potential',
        'quantity / brief action',
        'quantity disparity',
        'result',
        'result location',
        'resultative',
        '於-phrase (source/cause)',
    ]),
    'Copula': new Set([
        'cleft opener: it was…',
        'focus marker',
    ...
    'Object Morpheme': new Set([
        'noun morpheme of 散步 (split to end)',
        'noun morpheme of 见面 (split to end)',
        'separable noun half',
    ]),
    'Object': new Set([
        'adj → noun',
        ...
        'embedded clause',
        'embedded topic–comment clause',
        'emphasized extreme case',
        'fronted interrogative',
        'fronted pronoun (negation inversion)',
        'indefinite object: follows full complement',
        'inserted between direction and 去',
        'item B',
        'patient (thing that changed state)',
        'quoted speech',
        'reference point',
        'reflexive',
        'retained object',
    ...
    'Particle': new Set([
        ...
        'current relevance (still ongoing)',
        'degree',
        'direction',
        'durative',
        'emphatic fronting',
        ...
        'linker between duration and noun morpheme',
        'localizer',
        'nominalizer',
        'ongoing-state emphasis',
        'perspective',
        'potential',
        'question particle',
        'relativizer',
    ...
    'Pivot': new Set([
        'object of 使, subject of action',
        'object of 叫, subject of 去买',
        'object of 派, subject of 去谈判',
        'object of 让, subject of 回答',
        'object of 请, subject of 吃饭',
        'pivot',
    ]),
    'Predicate': new Set([
        'bare adjective',
    ...
    'Verb Morpheme': new Set([
        'reduplicated verb (AAB)',
        'separable verb',
    ]),
    'Verb Phrase': new Set([
        'comparison clause',
        ...
        'resultative',
        'separable verb',
        'serial verb (go + negotiate)',
        'serial verb (purpose chain)',
        'serial verb 3',
        'serial verb construction (purpose chain)',
        'serial verbs',
        'source clause',
        'trigger clause (一 + V)',
        'verb + object (first mention)',
        'verb repeated + duration complement',
        '於-phrase (locative)',
    ]),
};
