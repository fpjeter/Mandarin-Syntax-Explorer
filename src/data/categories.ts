...
export const FULL_CATEGORY_EXPLANATIONS: Record<SentenceCategory, string> = {
    ...
    'Correlative Patterns (越…越…)': 'These patterns link two clauses, showing how one change drives another. The most common are **越…越…** ("the more X, the more Y") and **一…就…** ("as soon as X, immediately Y"). No conjunction is needed between the clauses. Just the repeated marker does all the work: 越吃越胖, "the more you eat, the fatter you get."',
