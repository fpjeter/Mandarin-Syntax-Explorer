...
export const CATEGORY_DESCRIPTIONS: Record<SentenceCategory, string> = {
    ...
    'Comparatives': 'Compare two things with 比 (more than) or 跟…一样 (equally).',
    ...
    'Serial Verb Constructions': 'Chain two or more VPs sharing the same subject — no conjunction needed.',
    'Separable Verbs': 'Verbs that split apart to let aspect markers and complements slot in.',
    ...
    'Discourse Context': 'When context from a previous sentence lets Mandarin drop subjects entirely.',
};
