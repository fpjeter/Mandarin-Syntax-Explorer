            ...
            children: [
                {
                    ...
                    subRole: 'Location',
                    children: [
                        { id: 's99-t-hn', role: 'Head Noun', text: { hanzi: '墙', pinyin: 'qiáng', translation: 'wall' } },
                        { id: 's99-t-loc', role: 'Particle', subRole: 'localizer', text: { hanzi: '上', pinyin: 'shàng', translation: 'on/above' } }
                    ]
                },
                {
                    id: 's99-c',
                    role: 'Comment',
                    children: [
                        { id: 's99-c-hv', role: 'Head Verb', text: { hanzi: '挂', pinyin: 'guà', translation: 'hang' } },
                        { id: 's99-c-zhe', role: 'Particle', subRole: 'durative', text: { hanzi: '着', pinyin: 'zhe', translation: '(ongoing state)' } },
                        {
                            id: 's99-c-subj',
                            role: 'Subject',
                            subRole: 'existential subject',
                            children: [
                                { id: 's99-c-subj-num', role: 'Attributive', text: { hanzi: '一', pinyin: 'yī', translation: 'one' } },
                                { id: 's99-c-subj-mw', role: 'Attributive', subRole: 'measure word', text: { hanzi: '幅', pinyin: 'fú', translation: '(measure word)' } },
