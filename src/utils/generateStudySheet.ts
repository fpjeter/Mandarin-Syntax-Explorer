...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .literal-trans { font-style: italic; color: #9ca3af; font-family: 'Inter', sans-serif; white-space: nowrap; }
...
<body class="view-visual">
  ...
  <div class="footer">
    ...
    <div class="footer-right" style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.5rem;">
      <div>${sentence.id} · ${dateStr}</div>
      <img src="https://api.qrserver.com/v1/create-qr-code/?size=72x72&data=${encodeURIComponent(window.location.origin + '/#' + sentence.id)}" alt="QR Code" width="72" height="72" style="border-radius: 4px; border: 1px solid #e5e7eb; padding: 2px;" class="print-qr" />
    </div>
  </div>
