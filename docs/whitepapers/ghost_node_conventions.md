...
- Huang, C.-T.J. (2015). "On Syntactic Analyticity and Parametric Theory." In A. Li, A. Simpson & W.-T.D. Tsai (Eds.), *Chinese Syntax in a Cross-Linguistic Perspective* (pp. 1–48). Oxford: Oxford University Press. — Updates Huang (1984) with 30 years of refined parametric theory on pro-drop; directly strengthens the GCR foundations in Convention 1 and the pro-drop typology in Convention 4.
